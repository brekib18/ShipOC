...
insert into cereal_cereal(name, description, price, category_id) values ('Cocoa Puffs','Hver elskar ekki Cocoa Puffs? Hrikalega bragðgott.','650',2);
insert into cereal_cereal(name, description, price, category_id) values ('Cheerios','Eitt allra vinsælasta morgunkorn allra tíma!','420',2);
insert into cereal_cereal(name, description, price, category_id) values ('Weetabix','Hollt, gott og vegan!','400',2);
insert into cereal_cereal(name, description, price, category_id) values ('Corn Flakes','Morgunkornið sem allir elska.','580',2);
insert into cereal_cereal(name, description, price, category_id) values ('Barbara’s Shredded Wheat Cereal','100% sykulaust','500',2);
insert into cereal_cereal(name, description, price, category_id) values ('Corn Pops','600','Ómótstæðilegar morgunkúlur.',2);
insert into cereal_cereal(name, description, price, category_id) values ('Kashi','430','Fyrir þá sem vilja engan sykur.',2);
insert into cereal_cereal(name, description, price, category_id) values ('Frosted Flakes','600','Sykurhúðað Corn Flakes.',2);
insert into cereal_cereal(name, description, price, category_id) values ('Crispy Wheat & Raisins','440','Fullkomin máltið í skál.',2);
